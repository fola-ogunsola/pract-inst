<template>
  <form class="search" @submit.prevent="$emit('search')">
    <input type="text" name="search" placeholder="Search by name" v-model="keyword" />
